  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black text-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(30,94,204,0.15)_0%,transparent_70%)]" />
        ...
        >
          ...
          <h1 className="text-6xl md:text-8xl font-black mb-6 bg-gradient-to-r from-blue-400 via-blue-500 to-blue-600 bg-clip-text text-transparent tracking-tight">
            GALLI
            <br />
            TRAINING
          </h1>
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
            Consultoria online para <span className="text-blue-400 font-semibold">formação de treinos</span>{" "}
          ...
          <div className="flex justify-center">
            <Button
              variant="outline"
              size="lg"
              className="border-blue-500/50 text-blue-400 hover:bg-blue-600/10 px-8 py-6 text-lg bg-transparent"
              asChild
            >
              <Link href="/treinos">
        ...
        <div className="absolute top-20 left-10 w-20 h-20 bg-blue-600/10 rounded-full blur-xl animate-pulse" />
        <div className="absolute bottom-20 right-10 w-32 h-32 bg-blue-600/5 rounded-full blur-2xl animate-pulse delay-1000" />
      </section>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 animate-on-scroll opacity-0 translate-y-10 transition-all duration-800">
            {benefits.map((benefit, index) => (
              <Card
                key={index}
                className="bg-gradient-to-br from-gray-900 to-black border-blue-600/20 hover:border-blue-500/40 transition-all duration-300 group hover:scale-105"
              >
        ...
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center animate-on-scroll opacity-0 translate-y-10 transition-all duration-800">
            ...
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-blue-600/20 to-transparent rounded-3xl blur-3xl" />
              <Card className="bg-gradient-to-br from-gray-900 to-black border-blue-600/20 p-8 relative">
      ...
      {/* Member Access */}
      <section className="py-20 border-t border-blue-600/20">
